 ...
 * @author gzlzz
 */
public class EpiProduce extends javax.swing.JFrame {

    /**
     * Creates new form EpiProduce
     */
    public EpiProduce() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EpiProduce.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EpiProduce().setVisible(true);
            }
        });
    }
